...
In addition to the public-facing site (accessed from the root URL `/`), there is also a staff-only / accreditation site that is meant to be accessed only by staff and/or external accreditors. This site contains additional information (produced from the same mapping files), and can be accessed via the URL `/accreditation`.
