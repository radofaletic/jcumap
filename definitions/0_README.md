...
This folder contains JSON (JavaScript) files that provide important information about the structure of degrees and majors.
...
The other files in this directory describe programs (e.g. `AENGI.json`) and majors (e.g. `RENE-MAJ.json`).
